...
class BeanStoreImpl implements BeanStore {
	...
	BeanStoreImpl(TransactionManager transactionManager, ImmutableEntityStoreSet store, Runnable onCloseCallback) {
	...
	public BeanStoreCallbacks callbacks() {
		return new BeanStoreCallbacksImpl(transactionManager.storeWriter());
	}
