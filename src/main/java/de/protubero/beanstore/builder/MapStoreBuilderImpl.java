...
public class MapStoreBuilderImpl  extends AbstractStoreBuilder implements MapStoreBuilder {

	public static final Logger log = LoggerFactory.getLogger(MapStoreBuilderImpl.class);
	
	
	public MapStoreBuilderImpl(TransactionPersistence persistence) {
		super(persistence);
	}
