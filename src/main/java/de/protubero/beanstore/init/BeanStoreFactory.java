...
public class BeanStoreFactory {
	...
	private static class AppliedMigration {
	...
	private BeanStoreFactory(File file) {
		this();
		this.file = Objects.requireNonNull(file);
	}
	
	private BeanStoreFactory() {
		store = new Store();
	...
	public static BeanStoreFactory of(File file) {
		return new BeanStoreFactory(file);
	}
